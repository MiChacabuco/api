...
from michacabuco_admin.pharmacies.views import (
    PharmacyShiftLegacyViewSet,
    PharmacyShiftViewSet,
)
...
router.register("pharmacies/shifts", PharmacyShiftLegacyViewSet, basename="shifts")
